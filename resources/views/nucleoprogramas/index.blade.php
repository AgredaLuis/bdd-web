            ...
            <tbody class="text-uppercase tbody-font">
                ...
                <tr>
                    ...
                    <td class="text-center p-2">
                      <a href="{{ route('nucleoprogramas.edit',$elemento->id)}}" class="btn btn-sm btn-outline-secondary pt-2" title="Ver Detalles" style="width: 50%;">
                        <i class="si si-speech fa-2x i-font-details"></i>
                        <p class="m-0 font-w700 p-font-details">Detalles</p>
                      </a>
