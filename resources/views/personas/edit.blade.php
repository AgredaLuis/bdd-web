    ...
    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
      ...
      <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item text-black-75 active" aria-current="page">Mis Datos Personales</li>
        </ol>
      </nav>
    </div>
  </div>
...
<div class="content mb-3">
  ...
  <h2 class="content-heading pt-0 mb-0 pb-0 border-bottom font-note">Ingrese toda la información solicitada</h2>
  ...
  <div class="block block-rounded block-bordered mt-4">
    ...
    <div class="block-header block-header-default bg-white text-left pt-4 pb-2">
        <h5 class="block-title text-uppercase font-w700 font-size-sm text-black-75 border-bottom">Información Personal</h5>
    </div>    
              ...
              {{
                Form::text(
                  'ci',
                   null,
                  [
                    'class'=>'form-control text-uppercase font-size-input input-readonly numero required-form',
                    'id'=>'ci',
                    'required'=>true,
                  ]
                )
            ...
            <table class="table table-bordered table-hover table-striped table-vcenter" id="table-titulo">              
              ...
              @foreach ($Persona->titulos as $titulo)
                ...
                <tr class="row-details">
                  ...
                  <td class="text-center text-uppercase text-muted font-size-table" data-value="{{$titulo->id_tipotitulo}}" data-role="Titulo" data-type="Table" data-name="id_tipotitulo">{{ $titulo->tipotitulo->nombre }}</td>
                  <td class="text-center">
                    <i class="i-titulo" aria-hidden="true"></i>
                  </td>
              ...
              @endforeach
                ...
                <tr id="table-empty">            
                  <td colspan="3">
                    <h2 class="pt-0 mb-0 pb-0 text-uppercase text-center text-muted font-size-sm">No hay informacion academica registrada</h2> 
                  </td>
                </tr>                             
              </tbody>              
            </table>          
...
<script type="text/javascript">
  ...
  $(function () {   
    ...
    @if ( $Persona->id > 0)
      ...
      @if ($Persona->confirmado)
        ...
        $(".i-titulo").addClass('si si-check fa-2x text-success'); 
      ...
      @else
        ...
        $(".i-titulo").addClass('si si-close fa-2x text-danger btn-delete'); 
  ...
  function onBtnTituloClick(){
    ...
    html_tbody += "<td class='font-size-table'>";
    ...
    html_tbody += "</td>";
    html_tbody += "<td class='text-center text-uppercase text-muted font-size-table' data-value='" + $("#tipo option:selected").val() + "' data-role='Titulo' data-type='Table' data-name='id_tipotitulo'>"+ $("#tipo option:selected").text() +"</td>";
    html_tbody += "<td class='text-center'><i class='si si-close fa-2x text-danger btn-delete' aria-hidden='true' title='ELIMINAR'></i></td>";
